...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Menu - Clean Fullscreen Overlay */}
      <AnimatePresence>
        {isOpen && (
          <motion.div
            initial={{ opacity: 0 }}
            ...
            exit={{ opacity: 0 }}
            transition={{ duration: 0.3 }}
            className="lg:hidden fixed inset-0 top-16 bg-black-950/98 backdrop-blur-2xl"
          ...
          >
            <motion.div
              ...
              className="container-custom px-4 sm:px-6 py-8"
